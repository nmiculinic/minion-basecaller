...
_PREDICTREQUEST.fields_by_name['inputs'
                              ].message_type = _PREDICTREQUEST_INPUTSENTRY
...
_PREDICTRESPONSE.fields_by_name['outputs'
                               ].message_type = _PREDICTRESPONSE_OUTPUTSENTRY
