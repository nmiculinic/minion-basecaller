...
_SIGNATUREDEFMAP_SIGNATUREDEFENTRY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name=
            'tensorflow.serving.SignatureDefMap.SignatureDefEntry.value',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SIGNATUREDEFMAP = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _SIGNATUREDEFMAP_SIGNATUREDEFENTRY,
    ],
    enum_types=[],
    options=None,
    is_extendable=False,
...
_GETMODELMETADATARESPONSE_METADATAENTRY = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name=
            'tensorflow.serving.GetModelMetadataResponse.MetadataEntry.value',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_GETMODELMETADATARESPONSE = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _GETMODELMETADATARESPONSE_METADATAENTRY,
    ],
    enum_types=[],
    options=None,
    is_extendable=False,
...
DESCRIPTOR.message_types_by_name['GetModelMetadataRequest'
                                ] = _GETMODELMETADATAREQUEST
DESCRIPTOR.message_types_by_name['GetModelMetadataResponse'
                                ] = _GETMODELMETADATARESPONSE
