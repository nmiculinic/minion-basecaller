...
During this paper creation we used Sigopt academic licence for hyperparameter optimization. We gratefully acknowledge the support of NVIDIA Corporation with the donation of the Titan Xp GPU used for this research.
...
For data, we're thankful for cooperation of Biologists doc.~dr.~sc. Petra Korać and dr.sc. Paula Dobrinić and Loman labs~\cite{loman1-100k} for publicly posting their dataset.
