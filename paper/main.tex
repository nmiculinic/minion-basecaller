...
\begin{figure}[!h]
    \centering
    \theverbbox
    \caption{Target nucleotide sequence preprocessing. A' is surrogate nucleotide during training. After basecalling surrogate nucleotied are converted to original form.}
