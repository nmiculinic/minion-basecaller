...
\begin{sazetak}
Uređaj MinION firme Oxford Nanopore Technology prvi je prenosivi sekvencer DNA. Sposoban je pročitati nizove značajno velike duljine, preko 100 kBp, no nažalost pati od značajno vise pogrešaka nego ostale metode sekvenciranja.

U ovoj studiji kreirali smo MinCall, cjelokupni model očitanja nukleotida za MinION. Model je baziran na metodama dubokog učenja i koristi konvolucijske neuronske mreže u svojoj implementaciji. Za najbolje performanse koristi najnovije tehnike dubokog učenja i arhitekture, specifično rezidualne neuronske mreže, normalizaciju nad grupom i gubitak vezane vremenske klasifikacije.

Najuspješniji model, u koji je uključeno 270 slojeva neurona, postiže najbolje dosad zabilježene performan- se od 90.5\% preciznosti na skupu za učenje iz E. coli koristeći R9-kemiju nanopore i 1D-čitanja.
...
Finally, I'm thanking various other people whose code, tools and advice I've used in completing this paper: Fran Jurišić, Ana Marija Selak, and Ivan Sović.
