...
def _preprocess_batch(files_in_batch, generate_sam_f, ref_starts, out_root):
    name_to_file = {}
...
def generate_sam(ref_path, is_circular):
    ...
    with open(train_path, 'w') as trainf, open(test_path, 'w') as testf:
        for file_path in files:
            ...
            with open(file_path, 'r') as fin:
                ...
                elif start > reference_len * train_size:
                    # test data
...
if __name__ == '__main__':
    ...
    preprocess_all_ref(args.dataset_conf_path)
