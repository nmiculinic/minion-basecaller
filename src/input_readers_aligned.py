...
def get_feed_yield2(logger, block_size, num_blocks, file_list, batch_size=10, warn_if_short=False, root_dir=None):
...
def get_raw_feed_yield(logger, block_size_x, block_size_y, num_blocks, file_list, batch_size=10, warn_if_short=False,
                       root_dir=None):
    def load_f(fast5_path, ref_path):
